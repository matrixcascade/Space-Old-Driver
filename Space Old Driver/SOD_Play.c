...
px_void SOD_PlayRenderUI(SOD_Play *pPlay)
{
	...
	//分数
	PX_FontModuleDrawText(&pPlay->runtime->runtime.RenderSurface,300,30,(px_word *)SOD_TEXT_SCORE,PX_COLOR(255,0,0,0),&pPlay->runtime->fontmodule,PX_FONT_ALIGN_XLEFT);
	...
	utf16_text[i]=0;
	PX_FontModuleDrawText(&pPlay->runtime->runtime.RenderSurface,385,30,(px_word *)utf16_text,PX_COLOR(255,0,128,255),&pPlay->runtime->fontmodule,PX_FONT_ALIGN_XLEFT);
