...
px_void SOD_StartupRender(SOD_Startup *Startup,px_dword elpased)
{
	...
	PX_FontModuleDrawText(&Startup->pRuntime->runtime.RenderSurface,335,252,(px_word *)SOD_TEXT_START_GAME,PX_COLOR(255,0,0,0),&Startup->pRuntime->fontmodule,PX_FONT_ALIGN_XLEFT);
	PX_FontModuleDrawText(&Startup->pRuntime->runtime.RenderSurface,360,314,(px_word *)SOD_TEXT_ABOUT,PX_COLOR(255,0,0,0),&Startup->pRuntime->fontmodule,PX_FONT_ALIGN_XLEFT);
	PX_FontModuleDrawText(&Startup->pRuntime->runtime.RenderSurface,335,372,(px_word *)SOD_TEXT_EXIT_GAME,PX_COLOR(255,0,0,0),&Startup->pRuntime->fontmodule,PX_FONT_ALIGN_XLEFT);
}
